        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="text-left text-center lg:text-left">
            ...
            >
              ...
              <a href="/owntext.apk" download className="w-full sm:w-auto px-8 py-4 rounded-full bg-indigo-500/10 text-indigo-300 font-medium hover:bg-indigo-500/20 backdrop-blur-md transition-all duration-300 flex items-center justify-center gap-2 border border-indigo-500/20 hover:border-indigo-500/40">
